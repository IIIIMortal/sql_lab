...
# Form implementation generated from reading ui file 'systemadmin.ui'
#
...
class Ui_systemadmin(object):
    ...
    def retranslateUi(self, systemadmin):
        ...
        self.unit.setItemText(0, _translate("systemadmin", "学员十五队"))
        self.unit.setItemText(1, _translate("systemadmin", "研究生一队"))
        self.unit.setItemText(2, _translate("systemadmin", "研究生二队"))
        self.unit.setItemText(3, _translate("systemadmin", "信息通信系"))
        ...
        self.readtype.setItemText(0, _translate("systemadmin", "本科学员"))
        self.readtype.setItemText(1, _translate("systemadmin", "研究生学员"))
        self.readtype.setItemText(2, _translate("systemadmin", "教员"))
    ...
    def addreader(self):
        ...
        if res:
            ...
            self.getreadersinfo()
    def auto(self):
        if self.readtype.currentText()=='本科学员':
            self.totalnumber.setText('10')
        elif self.readtype.currentText()=='研究生学员':
            self.totalnumber.setText('20')
        elif self.readtype.currentText()=='教员':
